                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-30px gap-y-5">
                        ...
                        <div data-aos="fade-up" className="lg:col-start-1 lg:col-span-8">
                            <ul className="accordion-container curriculum create-course">
                                {/* accordion */}
                                <li onClick={() => openLiElement(1)} className={activeLi == 1 ? stylesLiActive : stylesLi}>
                                ...
                                {/* accordion */}
                                <li onClick={ () => openLiElement(2)} className={activeLi == 2 ? stylesLiActive : stylesLi}>
                                ...
                                {/* accordion */}
                                <li onClick={() => openLiElement(3)} className={activeLi == 3 ? stylesLiActive : stylesLi}>
                                    <div className="bg-whiteColor dark:bg-whiteColor-dark shadow-accordion dark:shadow-accordion-dark">
                                        {/* controller */}
                                        <div className="py-5 px-30px">
                                            <div className="cursor-pointer accordion-controller flex justify-between items-center text-lg text-headingColor font-semibold w-full dark:text-headingColor-dark font-hind leading-27px">
                                ...
                                {/* accordion */}
                                <li onClick={() => openLiElement(4)} className={activeLi == 4 ? stylesLiActive : stylesLi}>
                                    <div className="bg-whiteColor dark:bg-whiteColor-dark shadow-accordion dark:shadow-accordion-dark">
                                        {/* controller */}
                                        <div className="py-5 px-30px">
                                            <div className="cursor-pointer accordion-controller flex justify-between items-center text-lg text-headingColor font-semibold w-full dark:text-headingColor-dark font-hind leading-27px">
                                ...
                                {/* accordion */}
                                <li onClick={() => openLiElement(5)} className={activeLi == 5 ? stylesLiActive : stylesLi}>
                                        ...
                                        <div className="accordion-content transition-all duration-500 overflow-hidden h-0">
                                            <div className="content-wrapper py-4 px-5">
                                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-30px gap-y-5">
                                                    <div>
                                                        <img
                                                            src="../../assets/images/dashbord/dashbord__8.jpg"
                                                            className="w-full"
                                                            alt=""
                                                        />
                                                    </div>
                                                    <div>
                                                        <img
                                                            src="../../assets/images/dashbord/dashbord__4.jpg"
                                                            className="w-full"
                                                            alt=""
                                                        />
                                                    </div>
                                                    <div>
                                                        <img
                                                            src="../../assets/images/dashbord/dashbord__5.jpg"
                                                            className="w-full"
                                                            alt=""
                                                        />
                                                    </div>
                                                    <div>
                                                        <img
                                                            src="../../assets/images/dashbord/dashbord__9.jpg"
                                                            className="w-full"
                                                            alt=""
                                                        />
                                                    </div>
                                                    <div>
                                                        <img
                                                            src="../../assets/images/dashbord/dashbord__7.jpg"
                                                            className="w-full"
                                                            alt=""
                                                        />
                                                    </div>
